...
# Advfn.scrape_market_quarterly_split('NASDAQ', 'A', 'J')
# puts "Completed: NASDAQ: A-J"
# Advfn.scrape_market_quarterly_split('NASDAQ', 'K', 'Q')
# puts "Completed: NASDAQ: K-Q"
# Advfn.scrape_market_quarterly_split('NASDAQ', 'R', 'Z')
# puts "Completed: NASDAQ: R-Z"

# Advfn.scrape_market_quarterly_split('NASDAQ', 'O', 'P')
# puts "Completed: NASDAQ: O, P"
